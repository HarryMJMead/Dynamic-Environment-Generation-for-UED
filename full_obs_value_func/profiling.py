...
def main(config=None, project="JAXUED_TEST"):
    ...
    def train_step(carry, _):
        ...
        def get_optimal_return():
            ...
            _, optimal_return_dist = jax.lax.scan(
                iter_regret,
            ...
            return jnp.maximum((1 - 0.9 * (optimal_return_dist / config["student_num_steps"])), 0)

        optimal_return =  get_optimal_return()
        ...
        if config["metric"] == "optimal_regret":
            ...
            optimisation_metric = (crit_negative_value_loss / pro_eps) / config["student_num_steps"] 
