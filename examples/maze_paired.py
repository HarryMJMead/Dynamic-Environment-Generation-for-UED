...
if __name__=="__main__":
    ...
    group.add_argument("--student_gae_lambda", type=float, default=0.95)
    ...
    group.add_argument("--adv_gae_lambda", type=float, default=0.95)
    group.add_argument("--adv_entropy_coeff", type=float, default=1e-2)
